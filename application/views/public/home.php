...
<!-- //for-mobile-apps -->
<link href="<?php echo base_url(); ?>assets/Travel/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="<?php echo base_url(); ?>assets/Travel/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link href="assets/Travel/css/styles.css?v=1.6" rel="stylesheet">
<!-- js -->
<script src="<?php echo base_url(); ?>assets/Travel/js/jquery-1.11.1.min.js"></script>
<script src="<?php echo base_url(); ?>assets/Travel/js/scripts.js?v=1.7"></script>
<!-- //js -->
<!--FlexSlider-->
        <link rel="stylesheet" href="assets/Travel/css/flexslider.css" type="text/css" media="screen" />
        <script defer src="<?php echo base_url(); ?>assets/Travel/js/jquery.flexslider.js"></script>
...
<!--End-slider-script-->
<!-- pop-up-script -->
<script src="assets/Travel/js/jquery.chocolat.js"></script>
        <link rel="stylesheet" href="assets/Travel/css/chocolat.css" type="text/css" media="screen" charset="utf-8">
        <!--light-box-files -->
...
<!-- //pop-up-script -->
<script src="assets/Travel/js/easyResponsiveTabs.js" type="text/javascript"></script>
<!-- start-smoth-scrolling -->
<script type="text/javascript" src="assets/Travel/js/move-top.js"></script>
<script type="text/javascript" src="assets/Travel/js/easing.js"></script>
<script type="text/javascript">
                                                        ...
                                                        <div class="booking_room">
                                                            ...
                                                            <div class="reservation">
                                                                <ul>    
                                                                    ...
                                                                    <!---strat-date-piker---->
                                                                        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/Travel/css/jquery-ui.css" />
                                                                        <script src="<?php echo base_url(); ?>assets/Travel/js/jquery-ui.js"></script>
                                                                          <script>
                                                                                  $(function() {
                ...
                <div class="col-md-6 about-grid">
                    <div class="about-grid1">
                        ...
                        <div class="about-grid1-pos">
                            <img src="assets/Travel/images/1.jpg" alt=" " class="img-responsive" />
                        </div>
                    </div>
                </div>
                <div class="col-md-6 about-grid">
                ...
                <div class="col-md-6 about-grid">
                    <div class="about-grid1 about-grd1">
                        ...
                        <div class="about-grid1-pos1">
                            <img src="assets/Travel/images/2.jpg" alt=" " class="img-responsive" />
                        </div>
                    </div>
                </div>
                <div class="clearfix"></div>
                                ...
                                <div class="col-md-8 about-bottom-grid-right">
                                    <div class="col-md-4 about-bottom-grid-right-grid">
                                        <div class="about-bottom-grid-right-grid1">
                                            <img src="assets/Travel/images/4.jpg" alt=" " class="img-responsive" />
                                    ...
                                    <div class="col-md-4 about-bottom-grid-right-grid">
                                        <div class="about-bottom-grid-right-grid1">
                                            <img src="assets/Travel/images/5.jpg" alt=" " class="img-responsive" />
                                            <div class="about-bottom-pos">
                                    ...
                                    <div class="col-md-4 about-bottom-grid-right-grid">
                                        <div class="about-bottom-grid-right-grid1">
                                            <img src="assets/Travel/images/6.jpg" alt=" " class="img-responsive" />
                                            <div class="about-bottom-pos">
                        ...
                        <li>
                            <div class="about-bottom-grids">
                                ...
                                <div class="col-md-8 about-bottom-grid-right">
                                    <div class="col-md-4 about-bottom-grid-right-grid">
                                        <div class="about-bottom-grid-right-grid1">
                                            <img src="assets/Travel/images/8.jpg" alt=" " class="img-responsive" />
                                            <div class="about-bottom-pos">
                                                <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                                            </div>
                                            <p>officiis debitis</p>
                                    ...
                                    <div class="col-md-4 about-bottom-grid-right-grid">
                                        <div class="about-bottom-grid-right-grid1">
                                            <img src="assets/Travel/images/9.jpg" alt=" " class="img-responsive" />
                                            <div class="about-bottom-pos">
                                                <span class="glyphicon glyphicon-random" aria-hidden="true"></span>
                                            </div>
                                            <p>officiis debitis</p>
                                    ...
                                    <div class="col-md-4 about-bottom-grid-right-grid">
                                        <div class="about-bottom-grid-right-grid1">
                                            <img src="assets/Travel/images/7.jpg" alt=" " class="img-responsive" />
                                            <div class="about-bottom-pos">
                                                <span class="glyphicon glyphicon-briefcase" aria-hidden="true"></span>
                                            </div>
                                            <p>officiis debitis</p>
    ...
    <div class="awesome">
        <div class="container">
            ...
            <div class="col-md-8 awesome-right">
                ...
                <div class="col-md-4 awesome-right-grid">
                    <div class="awesome-right-grid1 view1 fifth-effect">
                        <img class="img-responsive" src="assets/Travel/images/1.jpg" alt=" " />     
                        <div class="social-icons">
                            <ul>
                                <li><a href="#" class="p"></a></li>
                                <li><a href="#" class="facebook"></a></li>
                ...
                <div class="col-md-4 awesome-right-grid">
                    <div class="awesome-right-grid1 view1 fifth-effect">
                        <img class="img-responsive" src="assets/Travel/images/2.jpg" alt=" " />     
                        <div class="social-icons">
                            <ul>
                                <li><a href="#" class="p"></a></li>
                                <li><a href="#" class="facebook"></a></li>
        ...
        <div class="container">
            ...
            <div class="main">
                <div class="view view-seventh">
                    <a href="assets/Travel/images/11.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        <img src="assets/Travel/images/11-.jpg" />
                        <div class="mask">
                ...
                <div class="view view-seventh">
                    <a href="assets/Travel/images/12.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        <img src="assets/Travel/images/12-.jpg" />
                        <div class="mask">
                            <h2>Necessitatibus</h2>
                            <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        </div>
                ...
                <div class="view view-seventh">
                    <a href="assets/Travel/images/13.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        <img src="assets/Travel/images/13-.jpg" />
                        <div class="mask">
                            <h2>Necessitatibus</h2>
                            <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        </div>
                ...
                <div class="view view-seventh">
                    <a href="assets/Travel/images/14.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        <img src="assets/Travel/images/14-.jpg" />
                        <div class="mask">
                            <h2>Necessitatibus</h2>
                            <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        </div>
            ...
            <div class="main">
                <div class="view view-seventh">
                    <a href="assets/Travel/images/15.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        <img src="assets/Travel/images/15-.jpg" />
                        <div class="mask">
                            <h2>Necessitatibus</h2>
                            <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        </div>
                ...
                <div class="view view-seventh">
                    <a href="assets/Travel/images/16.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        <img src="assets/Travel/images/16-.jpg" />
                        <div class="mask">
                            <h2>Necessitatibus</h2>
                            <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        </div>
                ...
                <div class="view view-seventh">
                    <a href="assets/Travel/images/17.jpg" rel="title" class="b-link-stripe b-animate-go  thickbox">
                        <img src="assets/Travel/images/17-.jpg" />
                        <div class="mask">
                            <h2>Necessitatibus</h2>
                            <p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>
                        </div>
        ...
        <div class="container">
            ...
            <div class="events-grids">
                <div class="col-md-4 events-grid">
                    <div class="cal">
                        <img src="assets/Travel/images/3.png" alt=" " class="img-responsive" />
                        <div class="cal-info">
    ...
    <div class="subscribe">
        <div class="container">
            ...
            <div class="men-heart-clock-twitter">
                ...
                <div class="col-md-3 men-text">
                    <img src="assets/Travel/images/heart.png" alt=" " />
                    <div class="men-txt">
                ...
                <div class="col-md-3 men-text">
                    <img src="assets/Travel/images/clock.png" alt=" " />
                    <div class="men-txt">
                ...
                <div class="col-md-3 men-text">
                    <img src="assets/Travel/images/twitter.png" alt=" " />
                    <div class="men-txt">
            ...
            <div class="col-md-3 footer-top-grid">
                ...
                <div class="flickr-grids">
                    <div class="flickr-grid">
                        <a href="#"><img src="assets/Travel/images/11.jpg" alt=" " class="img-responsive" /></a>
                    </div>
                    <div class="flickr-grid">
                        <a href="#"><img src="assets/Travel/images/12.jpg" alt=" " class="img-responsive" /></a>
                    </div>
                    <div class="flickr-grid">
                        <a href="#"><img src="assets/Travel/images/13.jpg" alt=" " class="img-responsive" /></a>
                    </div>
                    <div class="clearfix"> </div>
                    
                    <div class="flickr-grid">
                        <a href="#"><img src="assets/Travel/images/16.jpg" alt=" " class="img-responsive" /></a>
                    </div>
                    <div class="flickr-grid">
                        <a href="#"><img src="assets/Travel/images/14.jpg" alt=" " class="img-responsive" /></a>
                    </div>
                    <div class="flickr-grid">
                        <a href="#"><img src="assets/Travel/images/15.jpg" alt=" " class="img-responsive" /></a>
                    </div>
                    <div class="clearfix"> </div>
                </div>
            </div>
